...
lst_in = [
    ...
    "mail123@list.ru; Розыгрыш; Вы выиграли 1 млн. руб. Переведите "
    "30 тыс. руб., чтобы его получить.",
]
[print(x.is_read, x.mail_from, x.title, x.content) for x in mail.inbox_list]
[print(x.is_read, x.mail_from, x.title, x.content) for x in inbox_list_filtered]
