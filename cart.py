...
cart.add(TV("Philips 43PFS5505", 27990))
cart.add(TV("Xiaomi Mi TV P1 55", 45790))
cart.add(Table("TetChair Claire", 11290))
cart.add(Notebook("Lenovo IdeaPad L3 15ITL6", 61000))
cart.add(Notebook("HUAWEI MateBook 13", 69980))
cart.add(Cup("TetChair Claire", 11290))
