...
class Monkey(Monkeys, Description): pass
class Person(Human, Description): pass
class Flower(Flowering, Description): pass
class Worm(Worms, Description): pass

lst_objs = [
    Monkey("мартышка", 30.4, 7), Monkey("шимпанзе", 24.6, 8),
